...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'EatInformed AI Case Study | Amit Divekar',
    description: 'AI-powered food label intelligence platform using Gemini and Genkit.',
    creator: '@amitdevx_',
  },
};
      ...
      <header className="space-y-6 mb-16">
        ...
        <div className="flex flex-wrap items-center gap-4 pt-4">
          <Button asChild size="lg" className="bg-orange-600 hover:bg-orange-500 text-white">
            <Link href="https://eatinformed.amitdevx.tech/" target="_blank" rel="noopener noreferrer">
              Live Application
              <ExternalLink className="ml-2 h-4 w-4" />
            </Link>
          </Button>
          <Button asChild variant="outline" size="lg" className="border-white/10 hover:bg-white/5">
            <Link href="https://github.com/amitdevx/Eatinformed" target="_blank" rel="noopener noreferrer">
