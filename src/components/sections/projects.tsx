      ...
      <div className="w-full space-y-24">
        <SectionReveal>
          <div className="flex flex-col gap-4">
            <h2 id="projects-heading" className="font-headline text-3xl sm:text-4xl md:text-5xl font-bold break-words tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400">
              Featured Systems
            </h2>
        ...
        <div className="pt-24 border-t border-border/40">
          <SectionReveal>
            <h3 className="text-2xl font-bold mb-8 text-white">Other Experiments</h3>
          </SectionReveal>
