...
image: "/blogs/gcp-cloud-run-gke-ai-workloads/gcp-cloud-run-gke-ai-workloads-banner.png"
...
![GCP Cloud Run vs GKE](/blogs/gcp-cloud-run-gke-ai-workloads/gcp-cloud-run-gke-ai-workloads-banner.png)
