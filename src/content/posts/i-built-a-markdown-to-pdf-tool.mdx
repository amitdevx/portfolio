...
date: "2026-06-27"
updated: "2026-06-27"
description: "Introducing @amitdevx/md2pdf: A new, reliable Node.js CLI tool and library to convert Markdown to beautiful PDF files. Currently in v0.1.6, solving core Markdown-to-PDF formatting."
image: "/blogs/md2pdf/hero.png"
tags: ["Markdown", "PDF", "Open Source", "npm", "Node.js", "CLI", "Markdown to PDF", "Playwright"]
author: "Amit Divekar"
---
...
## 4. Current State: v0.1.6 Features & Usage

The tool is live on npm at **v0.1.6**! Right now, it perfectly handles standard Markdown-to-PDF conversion, focusing on clean typography, excellent code block rendering, local images, and proper page break management.
...
While v0.1.6 handles the core functionality beautifully, I built this AST-based architecture specifically to be extensible. Here is what is actively in development for upcoming updates:

- **Mermaid Diagrams:** Native, zero-config rendering of Mermaid diagrams directly in the Markdown.
- **KaTeX:** Support for beautiful math equations.
- **Obsidian Compatibility:** Parsing and rendering those handy `> [!note]` callouts, embeds, and `[[internal wiki links]]`.
- **Advanced Theming:** Built-in beautiful themes (light/dark, academic, minimal) with easy CSS overrides.
